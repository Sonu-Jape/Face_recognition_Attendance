...
class Developer:
    def __init__(self, root):
        ...
        img_top1 = Image.open(r"college_images\passport size photo.jpg")
        ...
        # Developer info
        dev_label = Label(main_frame,text="Hello my name is,Deepak",font=("times new roman",20,"bold"),fg="blue",bg="white")
        dev_label.place(x=0,y=5)


        dev_label = Label(main_frame,text="I am  Python Developer",font=("times new roman",20,"bold"),fg="blue",bg="white")
